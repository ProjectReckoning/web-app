...
import ChartWithTabs, {
  ChartData,
} from "@/features/insight/components/chart-with-tabs.component";
...
import PieChartWithTabs, {
  PieChartTabData,
} from "@/features/insight/components/pie-chart-with-tabs.component";
...
const DATA: ChartData[] = [
  {
    ...
    series: {
      makanan: {
        data: [
          1_200_000, 1_500_000, 1_450_000, 1_600_000, 1_700_000, 1_750_000,
        ],
        color: "#ff6384",
      },
      transportasi: {
        data: [300_000, 350_000, 330_000, 400_000, 420_000, 450_000],
        color: "#36a2eb",
      },
      hiburan: {
        data: [500_000, 600_000, 550_000, 700_000, 800_000, 900_000],
        color: "#ffce56",
      },
      tagihan: {
        data: [900_000, 950_000, 1_000_000, 1_050_000, 1_100_000, 1_150_000],
        color: "#4bc0c0",
      },
    },
  },
  {
    ...
    series: {
      gaji: {
        data: [
          7_000_000, 7_000_000, 7_000_000, 7_500_000, 8_000_000, 8_000_000,
        ],
        color: "#81c784",
      },
      freelance: {
        data: [
          1_000_000, 1_200_000, 1_000_000, 1_500_000, 1_600_000, 1_800_000,
        ],
        color: "#9575cd",
      },
      investasi: {
        data: [250_000, 300_000, 320_000, 350_000, 370_000, 400_000],
        color: "#ffb74d",
      },
    },
  },
...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <Stack spacing={2}>
        <Typography variant="h6">Pilih Periode</Typography>
